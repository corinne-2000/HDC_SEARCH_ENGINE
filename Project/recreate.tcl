...
#
# SearchEngine.tcl: Tcl script for re-creating project 'SearchEngine'
#
# Generated by Vivado on Sat Apr 15 02:57:29 HDT 2023
...
set _xil_proj_name_ "SearchEngine"
...
# Create project
create_project -force ${_xil_proj_name_} -part xczu2cg-sfvc784-1-e
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../HLS/SearchEngine/hls_project/alinx/impl/ip"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../IP/BlockDesign/BlockDesign.bd"] \
 [file normalize "${origin_dir}/../IP/BlockDesign/hdl/BlockDesign_wrapper.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../IP/BlockDesign/BlockDesign.bd"
...
set file "$origin_dir/../IP/BlockDesign/hdl/BlockDesign_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu2cg-sfvc784-1-e -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu2cg-sfvc784-1-e -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
